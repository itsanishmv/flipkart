...
function Filter({
  ...
  return (
    <div className="relative rounded-lg w-1/5 p-3 h-[100vh] flex flex-col gap-4 bg-default">
      <div className=" text-lg font-medium">Filters</div>
      <span
        className=" absolute right-2 text-flipkart-blue cursor-pointer"
      ...
      <div>
        <span className=" text-md font-semibold text-flipkart-grey">Sizes</span>
        {sizesList.map((el) => (
          <div className="flex gap-2">
            <input type="checkbox" value={el} onChange={(e) => handleSize(e)} />
            <span>{el}</span>
          </div>
        ))}
      </div>
      ...
      <div className="flex flex-col">
        <span className="text-md font-semibold text-flipkart-grey">Price</span>
